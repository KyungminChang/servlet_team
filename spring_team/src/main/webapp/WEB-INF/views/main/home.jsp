    ...
    <div class="carousel-wrapper">
        <div class="carousel">
            ...
            <%-- <div class="movie-card">
           		 <a href="<c:url value="/main/moviedetail?mo_num=${list[0].mo_num}"/>">
            ...
            <div class="movie-card">
            	<a href="<c:url value="/main/moviedetail?mo_num=${list[1].mo_num}"/>">
            ...
            <div class="movie-card">
            	<a href="<c:url value="/main/moviedetail?mo_num=${list[2].mo_num}"/>">
            ...
            <div class="movie-card">
            	<a href="<c:url value="/main/moviedetail?mo_num=${list[3].mo_num}"/>">
